...
//		
		...
		spielStarten2 = new JButton("Spiel starten");
		spielStarten2.setFont(new Font("Arial", Font.BOLD, 12));
		spielStarten2.setBackground(Color.WHITE);
		spielStarten2.setBounds(300, 220, 120, 30);	
	...
	private void addListener() {
		spielStarten2.addActionListener(event);
		spielStarten2.setActionCommand("spielStarten2");
	}
	

	public JButton getSpielStarten() {
		return spielStarten2;
	}
