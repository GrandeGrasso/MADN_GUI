...
import javax.swing.JOptionPane;
	...
	public class Mail extends Thread {
		...
		public Mail(String an, String betreff, String text, 
			...
			p.put("mail.smtp.user", "rusinov");//"IHR BENUTZERNAME" z.B "frommer"
			p.put("mail.smtp.password", "kennwort");//IHR KENNWORT
			p.put("mail.smtp.socketFactory.port", "465");
			p.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
			p.put("mail.smtp.auth", "true");
			p.put("mail.smtp.port", "465");
			p.put("von", "Julija.Rusinov@Student.Reutlingen-University.DE");//IHRE MAILADRESSE z.B "Sina_Mailin.Frommer@Student.Reutlingen-University.DE"
			p.put("an", an);
