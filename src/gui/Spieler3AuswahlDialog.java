...
public class Spieler3AuswahlDialog {
	
	
	JFrame frame;
	JButton spielStarten3;
...
//		
		...
		spielStarten3 = new JButton("Spiel starten");
		spielStarten3.setFont(new Font("Arial", Font.BOLD, 12));
		spielStarten3.setBackground(Color.WHITE);
		spielStarten3.setBounds(300, 220, 120, 30);	
	...
	private void addListener() {
		spielStarten3.addActionListener(event);
		spielStarten3.setActionCommand("spielStarten3");
	}
	

	public JButton getSpielStarten() {
		return spielStarten3;
	}
